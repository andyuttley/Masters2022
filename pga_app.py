...
def user_input_features():
    ...
    sga2g = st.sidebar.slider('SG Approach to Green', 0, 100, 70, 5)
    sgatg = st.sidebar.slider('SG Around the Green', 0, 100, 90, 5)
    sgputt = st.sidebar.slider('SG Putting', 0, 100, 40, 5)
    sgmasters = st.sidebar.slider('SG Masters History', 0, 100, 80, 5)
    sgtotal = st.sidebar.slider('SG Total', 0, 100, 40, 5)
...
df_results2['Rounded Suggested Odds'] = ((100/df_results2['prediction']).astype(int)).astype(str)+'/1'
